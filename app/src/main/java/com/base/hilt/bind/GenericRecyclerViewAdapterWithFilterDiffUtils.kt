 ...
 * Generic Filterable Adapter with DiffUtils
 ...
 * @property removeItem(position) Remove item using given Position from filtered list, and using that item from main list
 ...
 * @property getOriginalListSize() returns size of mArrayList list
 * @property areItemsSame() Method to compare items to smoothly refresh any item whenever changes in item occurs
 * @property areContentSame() Method to compare content of items to smoothly refresh any item whenever changes in item occurs
...
abstract class GenericRecyclerViewAdapterWithFilterDiffUtils<T, D>() :
    ...
    abstract fun areItemsSame(newItem: T?, oldItem: T?): Boolean

    abstract fun areContentSame(newItem: T?, oldItem: T?): Boolean
...
//    abstract fun onFilterComplete(query: CharSequence?, result: ArrayList<T>)
    ...
    private fun setData(newList: ArrayList<T>, oldList: ArrayList<T>) {
        val differ = MyDiffUtils(oldList, newList)
    ...
    inner class MyDiffUtils(
        ...
        override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
            return areItemsSame(newList[newItemPosition], oldList[oldItemPosition])
        }

        override fun areContentsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
            return areContentSame(newList[newItemPosition], oldList[oldItemPosition])
        }
    }
}
